...
namespace FRANCHISE
{
    public partial class BranchEmployee : DevExpress.XtraEditors.XtraForm
    {
        public int BranchID;
        ...
        {
            ELL.EMPLOYEE[] Employee = BLL.EMPLOYEE.BranchEmployeeList(BranchID);
            ...
            gridView1.Columns[3].Caption = "ÇALIŞAN KİMLİK";
            ...
            gridView1.Columns[7].Caption = "KULLANICI ADI";
            gridView1.Columns[8].Caption = "KULLANICI ŞİFRE";
            gridView1.Columns[9].Caption = "UNVAN AD";
            gridView1.Columns[11].Caption = "SUBE AD";
            gridView1.Columns[13].Caption = "ÇALIŞAN DURUM";
        ...
        private void BranchEmployee_Load(object sender, EventArgs e)
        {
            EmployeeList();
            ButtonStatus();
            AppellationList();
        ...
        private void btnChangeState_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                BLL.PRODUCT.ChangeStateProduct(EmployeeID, State);
                EmployeeID = 0;
